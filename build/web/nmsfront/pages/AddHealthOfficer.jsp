<%-- 
    Document   : AddHealthOfficer
    Created on : 07-May-2015, 23:51:35
    Author     : Elijah
--%>
...
<html>
   <head>
    ...
    <title>EMHDMS-Add H-Officer</title>
...
<!--                <li class="dropdown">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Health Officers</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="../../sev/addhealthoff">
                                        <div class="form-group">
                                            <label>First Name</label>
                                            <input class="form-control" name="fname">
                                            <p class="help-block">Enter the user first name.</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="username" placeholder="Enter the  username">
                                        </div>
                                        <div class="form-group">
                                            <label>Password</label>
                                            <input class="form-control" name="password" placeholder="Enter the  login password">
                                        </div>
<!--                                        <div class="form-group">
                                            <label>Repeat password</label>
                                            <input class="form-control" name="passwordagain" placeholder="Repeat  the  password">
                                        </div>-->
                                         <div class="form-group">
                                            <label>Select User level</label>
                                            <select class="form-control" name="level">
                                                <option value="1">NMS Admin</option>
                                                <option value="2">HC1</option>
                                                <option value="3">HC2</option>
                                                <option value="4">HC3</option> 
                                                <option value="5">HC4</option>  
                                            </select>
                                        </div>
                        ...
                        int size = DLlist.size();                    
                                 ...
                                 District obj= DLlist.get(i);
                                   ...
                                   %>
                                   <option value="<%=obj.getDistrictno()%>">
