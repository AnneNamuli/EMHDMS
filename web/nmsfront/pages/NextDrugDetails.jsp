<%-- 
    Document   : Next Delivery details
...
<!--                <li class="dropdown">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Next Delivery Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="../../sev/deliverydetails">
                                       
                                        
                                        <div class="form-group">
                                            <label> Fill Delivery Details </label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p class="help-block">Enter the deliverer's phone no.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Expected Date(YYYY/MM/DD) </label>
                                            <input class="form-control" name="exptime">
                                            <p class="help-block">Enter the expected date of delivery.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Delivery date</label>
                                            <input class="form-control" name="datedelivered">
                                            <p class="help-block">Enter the Actual of delivery.</p>
                                        </div>
                        ...
                        int sizee = Hflist.size();                    
                                 ...
                                 HealthFac objj=Hflist.get(ii);
                                   ...
                                   <option value="<%=objj.getNo()%> ">
                                        ...
                                        <button type="submit" class="btn btn-default">Send Details</button>
