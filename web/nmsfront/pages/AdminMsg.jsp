                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <form role="form" method="POST" action="../../sev/adminmsg">
                                <div class="col-lg-6">
                                    ...
                                    <button type="submit" class="btn btn-success" name="inout" value="2">Send Mail</button>
                                ...
                                <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Health Facility Region</label>
                                            ...
                                            <p class="help-block">Select the Region.</p>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Health Facility District</label>
                        ...
                        int size = DLlist.size();                    
                                 ...
                                 District obj= DLlist.get(i);
                                   ...
                                   <option value="<%=obj.getDistrictno()%>">
                                            ...
                                            <p class="help-block">Select the District.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Health Centre Name</label>
                        ...
                        int sizee = Hflist.size();                    
                                 ...
                                 HealthFac objj=Hflist.get(ii);
                                   ...
                                   <option value="<%=objj.getNo()%>">
                                            ...
                                            <p class="help-block">Select the Health Centre.</p>
                                        </div>
                                <!-- /.col-lg-6 (nested) -->
                                </div>
                                </form>
