                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            List of all the distribution Regions in the country
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <form action="/FinalYearProject/sev/getzones" >
...
//                                        String css []= {"success","danger","info","warning"};                        
                                         ...
                                         List <Zones> ZLlist= LogicController.getZones();
                                        int size = ZLlist.size();                    

                                                 for(int i = 0; i< size; i++) {
                                                 Zones obj= ZLlist.get(i);
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            These are the current distribution Districts
                        </div>
