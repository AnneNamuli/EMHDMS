...
<!--                <li class="dropdown">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Confirm Delivery</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Click the button to confirm the delivery 
                        </div>
...
//                                        String css []= {"success","danger","info","warning"};                        
                    ...
                    <div class="panel panel-green">
                        ...
                        <div class="panel-body">
                            <p>Please select Accept if the drug quantities received are the Exact</p>
                        </div>
...
<button type="submit" class="btn btn-primary btn-lg btn-block" value="Yes" name="confirm">confirm</button>
