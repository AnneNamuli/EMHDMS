<%-- 
    Document   : AddHealthFacility
    Created on : 05-May-2015, 18:57:18
    Author     : Elijah
--%>
...
<!--                <li class="dropdown">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Health Facilities</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="../../sev/addhealthfacility">
                                        <div class="form-group">
                                            <label>Health Facility Name</label>
                                            <input class="form-control" name="hfname">
                                            <p class="help-block">Enter the desired new name.</p>
                                        </div>
                                        
                                        
                                        <div class="form-group">
                                            <label>Location</label>
                                            <input class="form-control" name="loaction" placeholder="Enter Actual Location here. e.g Trading Center name">
                                        </div>
                                         <div class="form-group">
