                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <form  action="/FinalYearProject/sev/messages">
...
//                                        String css []= {"success","danger","info","warning"};                        
                                         ...
                                         List <Messages> MLlist= LogicController.getMessages();
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td ><a href="AdminMsg.jsp"><button type="button" class="btn btn-success" >Reply</button></a></td>
<!--                                            <td class="center"><%%></td>
